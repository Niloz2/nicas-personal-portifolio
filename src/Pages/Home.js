        ...
        <div className="row">
          <div className="col-md-4">
            ...
            <p>
              ...
              architecture with Laravel, React and Bootstrap. Played a key role
              in the successful launch of multiple client projects.
            </p>
            <a href="https://www.announcevent.com" target="blank">Visit AnnounceVent</a>
          </div>
          <div className="col-md-4">
            <h5 className="fw-bold">
            ...
            <p>
              ...
              Laravel. Collaborated with cross-functional teams to enhance user
          ...
          <div className="col-md-4">
            ...
            <p>
              Participated in training that based on software development using
              Java in building web applications and Android applications, Gained
              experience on Frontend Technologies HTML,CSS,JAVASCRIPT. Gained
              foundational experience in full-stack development.
            </p>
          </div>
        </div>
      </div>
